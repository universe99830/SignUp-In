...
export const ThemeProvider = ({ children, ...props }) => {
  const [theme, setTheme] = useState({
    ...props.theme,
    colors: JSON.parse(window.localStorage.getItem('isLightMode')) ? darkThemeColors:lightThemeColors,
    isLightMode: JSON.parse(window.localStorage.getItem('isLightMode')) || true
  })
