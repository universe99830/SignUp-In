...
export const OriginalHero = () => {
  return (
    ...
    //       <LeftWrapper>
    //         <h1>
    //           <span className="marker">OutSyde Originals</span> <span className="marker">NFT Collection</span>
    //         </h1>
    ...
    //           <span className="hide_mobile">OutSyde on </span>Discord
    //         </SocialItem>
    ...
    //           <span className="hide_mobile">OutSyde on </span>Twitter
    //         </SocialItem>
    //       </SocialWrapper>
    //     </BottomContent>
    //   </InnerContainer>
